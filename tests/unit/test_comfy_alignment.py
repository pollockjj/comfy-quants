...
class TestComfyAlignment(unittest.TestCase):
    def test_registry_has_builtin_components(self):
        ...
        self.assertIn("anima", list_adapters())
        self.assertIn("anima_14b", list_adapters())
    ...
    def test_comfyui_contract_index_is_static_artifact_metadata(self):
        ...
        self.assertIn("anima", contracts["contracts"])
        self.assertEqual(contracts["contracts"]["anima"]["artifact_target"], "comfyui")
